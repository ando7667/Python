...
#   in >> 10 True
#   out >> ['дом ночью мягкий', 'огонь завтра зеленый', 'лес вчера яркий',
#               'автомобиль сегодня веселый', 'город позавчера утопичный']
#
#   in >> 10 False
#   out >> ['автомобиль ночью мягкий', 'огонь вчера веселый', 'автомобиль позавчера веселый', 'город вчера утопичный',
...
# =========  Пример решения задачи от Преподавателя ============================
